...
ratified by Ticket 0058; a routing-only attestation-binding contract
and a direct-refutation contract must still follow. A bare
...
A routing-only attestation-binding contract, a direct-refutation
contract, and any runtime remain future.
