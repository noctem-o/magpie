...
Historical ancestry through the post-#146 baseline: the earlier sequence through
`c70c0fb` (#118) remains as previously recorded. Its historical extension is
...
Current ancestry extension, verified against GitHub and Git parents on
